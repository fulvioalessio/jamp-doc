...
$propertyHELP["tabs"]                  = "ID inoltrato al TAB. Proprietà impostata dal sistema.";
...
$propertyHELP["tabswidth"]             = "Dimensione delle linquette dei tab (con unità di misura es: 100px, 100%).";
$propertyHELP["align"]                 = "Allineamento orizzontale.|left,center,right";
$propertyHELP["selected"]              = "Tab selezionato di default.";
