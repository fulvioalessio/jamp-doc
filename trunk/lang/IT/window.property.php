...
$propertyHELP["display"]               = "Non va impostata serve per ereditare la propriet&#224; dall'oggetto padre.";
$propertyHELP["align"]                 = "Allineamento del contenuto della finestra.|left,center,right,justify";
...
$propertyHELP["duration"]              = "Cosente di specificare la durata in millisencondi dell'animazione di apertura e chiusura della finestra.";
$propertyHELP["alg"]                   = "Algoritmo utilizzato dall'animazione.|default,sin,cos";
$propertyHELP["expanded"]              = "Stato iniziale della finestra.\nSe \"none\" viene visualizzata una finestra a dimensione fissa.|true,false,none";
$propertyHELP["label"]                 = "Etichetta dell'oggetto.";
$propertyHELP["java"]                  = "Nome del/dei file javascript usati dall'oggetto.";
$propertyHELP["type"]                  = "Orientamento dell'oggetto.|vertical,horizontal";
