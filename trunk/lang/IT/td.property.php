...
$propertyHELP["colspan"]               = "Numero di colonne da unire.";
$propertyHELP["height"]                = "Altezza dell'oggetto (con unità di misura es: 600px).";
$propertyHELP["rowspan"]               = "Numero di righe da unire.";
$propertyHELP["align"]                 = "Allineamento orizzontale.|left,center,right";
$propertyHELP["valign"]                = "Allineamento allineamento verticale.|baseline,bottom,center,top";
$propertyHELP["bgcolor"]               = "Colore di sfondo.";
$propertyHELP["background"]            = "Immagine di sfondo.";
$propertyHELP["nowrap"]                = "Blocca ritorno a capo.|true,false";
$propertyHELP["abbr"]                  = "Abbreviazione del contenuto della cella.";
$propertyHELP["axis"]                  = "Asse (indice) di categoria.";
$propertyHELP["char"]                  = "Specifica il carattere a cui allineare il testo.";
$propertyHELP["charoff"]               = "Decentramento per il carattere di allineamento.";
$propertyHELP["headers"]               = "Elenco di id per celle d'intestazione.";
$propertyHELP["scope"]                 = "Specifica l'insieme di celle di dati per le quali la cella d'intestazione corrente fornisce informazioni d'intestazione.|row,col,rowgroup,colgroup";
?>