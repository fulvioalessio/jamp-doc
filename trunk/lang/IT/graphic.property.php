...
$propertyHELP["src"]                   = "Percorso dell'immagine.";
$propertyHELP["path"]                  = "Path relativa della classe utilizzata per la visualizzazione del file generato.\n Di default viene utilizzata la classe jamp/class/tmpfile.php?filename=\$id.png";
$propertyHELP["hide"]                  = "Nasconde il grafico.|true,false";
...
$propertyHELP["href"]                  = "URL da aprire.";
$propertyHELP["target"]                = "Destinazione degli URL da aprire.";
$propertyHELP["ismap"]                 = "Specifica se l'oggetto è una mappa.|true,false";
$propertyHELP["longdesc"]              = "Descrizione.";
$propertyHELP["name"]                  = "Nome dell'oggetto.";
$propertyHELP["usemap"]                = "Mappa dell'oggetto.";
