...
$propertyHELP["cellspacing"]           = "Spaziatura tra celle.";
$propertyHELP["border"]                = "Dimensione del bordo.";
$propertyHELP["cellpadding"]           = "Spaziatura interna alla cella.";
$propertyHELP["align"]                 = "Allineamento orizzontale.|left,center,right";
$propertyHELP["bgcolor"]               = "Colore di sfondo.";
$propertyHELP["frame"]                 = "Bordi della cella visualizzati.|void,above,below,hsides,vsides,lhs,rhs,box,border";
$propertyHELP["id"]                    = "Nome univoco dell'oggetto.";
$propertyHELP["background"]            = "Colore di sfondo.";
$propertyHELP["rules"]                 = "Specifica quali filetti separatori appariranno tra le celle all'interno di una tabella.|none,groups,rows,cols,all";
$propertyHELP["summary"]               = "Sommario della tabella.";
$propertyHELP["caption"]               = "Titolo della tabella.";
?>