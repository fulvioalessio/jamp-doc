...
$propertyHELP["lang"]                  = "Nome univoco dell'oggetto.";
$propertyHELP["dir"]                   = "Nome univoco dell'oggetto.";
$propertyHELP["template"]              = "Nome del template utilizzato dall'oggetto, se non specificato viene utilizzato quello di sistema.";
$propertyHELP["title"]                 = "Nome univoco dell'oggetto.";
$propertyHELP["id"]                    = "Nome univoco dell'oggetto.";
$propertyHELP["type"]                  = "MIME type ovvero la specifica del tipo di dati che vengono trasferiti";
$propertyHELP["align"]                 = "Allineamento del testo attorno all'oggetto.|left,right,top,bottom";
$propertyHELP["archive"]               = "Lista di URL separati da spazi, Gli archivi contenenti risorse rilevanti dell'oggetto.";
$propertyHELP["border"]                = "Dimensione del bordo.";
$propertyHELP["classid"]               = "Definisce il valore della classe ID settato nel registro di finestra o URL";
$propertyHELP["codebase"]              = "URL su dove trovare il codice dell'oggetto";
$propertyHELP["codetype"]              = "Internet media type del codice riferito all'attributo classid";
$propertyHELP["data"]                  = "URL con riferimento ai dati dell'oggetto";
$propertyHELP["declare"]               = "Ogni oggetto dovrebbe essere solo dichiarato e non creato o istanziato fino a quanto non sia necessario";
...
$propertyHELP["hspace"]                = "Margine orizzontale";
$propertyHELP["name"]                  = "Nome dell'oggetto.";
$propertyHELP["standby"]               = "Testo da mostrare durante il caricamento dell'oggetto";
$propertyHELP["usemap"]                = "URL lato client dell'immagine della mappa da essere usata nell'oggetto";
$propertyHELP["vspace"]                = "Margine verticale.";
?>