...
$propertyHELP["order"]                 = "Consente di ordinare la colonna.|true,false";
$propertyHELP["readonly"]              = "Oggetto in sola lettura.|true,false";
$propertyHELP["insertnew"]             = "Visualizza la riga da inserire nella griglia.|true,false";
...
$propertyHELP["display"]               = "ID dell'oggetto che visualizza/nasconde la griglia.\nEs. \"display\"=\"tabs1\"\nL'init della griglia avverà solamente alla chiamata della funzione tabs1Display().\n Per un corretto funzionamento della griglia l'inizializzazione deve avvenire quando la griglia non è nascosta dal css. Non è necessario impostare questo valore poichè viene ereditato automaticamente in base all'oggetto in cui si trova la griglia.";
$propertyHELP["java"]                  = "Nome del/dei file javascript usati dall'oggetto.";
$propertyHELP["pdffont"]               = "Font PDF";
$propertyHELP["pdffontsize"]           = "Dimensione del font PDF";
$propertyHELP["dsobj"]                 = "ID dell'oggetto datasource associato.";
$propertyHELP["autoscroll"]            = "Abilita/Disabilita la modalità di autoscroll.|true,false";
?>