...
$propertyHELP["minlength"]             = "Cosente, se usato insieme a \"blur\", di specificare la lunghezza minima del testo.";
...
$propertyHELP["dsitemlabel"]           = "Nome del campo da visualizzare nell'area di testo della select.";
...
$propertyHELP["outlabel"]              = "Visualizza la select come se fosse una label.|true,false";
