...
$propertyHELP["charset"]               = "Set di caratteri usato nel link";
$propertyHELP["coords"]                = "Coordinate da usare con l'image map";
$propertyHELP["href"]                  = "URL da aprire.";
$propertyHELP["hreflang"]              = "Codice lingua url";
$propertyHELP["name"]                  = "Nome dell'oggetto.";
$propertyHELP["rel"]                   = "Relazione fra il documento dove punta il link e il documento corrente";
$propertyHELP["rev"]                   = "Relazione fra il documento corrente e il documento dove punta il link ";
$propertyHELP["shape"]                 = "Specifica la forma della regione da usare con loimage map.|default,rect,circle,poly";
$propertyHELP["target"]                = "Destinazione degli URL da aprire.";
$propertyHELP["type"]                  = "Tipo link";
$propertyHELP["text"]                  = "Testo del link.";
