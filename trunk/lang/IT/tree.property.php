...
$propertyHELP["refresh"]               = "Modalità di caricamento dell'albero.|tree,branche,always";
$propertyHELP["dragable"]              = "Attiva il drag end drop.|true,false";
$propertyHELP["checkbox"]              = "Attiva la selezione.\n- dualstate: visualizza le checkbox con selezione singola.\n - tristate: visualizza le checkbox con selezione dei figli.|dualstate,tristate,none";
$propertyHELP["oncontextmenu"]         = "Visualizza il menù contestuale.|true,false";
$propertyHELP["menuname"]              = "Voce del menù contestuale";
$propertyHELP["menufunction"]          = "Funzione richiamata dal menu contestuale";
$propertyHELP["menufilter"]            = "Espressione regolare usata per testare il valore del nodetype selezionato. Consente di visualizzare la voce del munù in base al nodo.";
$propertyHELP["dslink"]                = "Nome campo ds contenente il link del nodo da richiamare al al click del testo del nodo.";
$propertyHELP["dsorder"]               = "Rappresenta il nome campo contenente l'ordine dei nodi all'interno del ramo";
$propertyHELP["dsicon"]                = "Nome del campo contenente lo style dell'icona da associare al nodo.";
$propertyHELP["dsnochild"]             = "Nome del campo contenente l'informazione per stabilire se un nodo può avere figli o meno.";
$propertyHELP["dsdragable"]            = "Nome del campo contenente l'informazione del singolo nodo per poter essere spostato o meno.";
$propertyHELP["dscheckstate"]          = "Nome del campo contenente l'informazione nel quale memorizzare lo stato della checkbox.";
