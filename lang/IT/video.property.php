...
$propertyHELP["autoplay"]              = "Esegue il video al caricamento.|true,false";
$propertyHELP["controls"]              = "Visualizza i controlli.";
$propertyHELP["wmode"]                 = "Proprietà window mode.";
$propertyHELP["loop"]                  = "Ripete il video.";
$propertyHELP["console"]               = "Proprietà console.";
$propertyHELP["nojava"]                = "Proprietà nojava.";
$propertyHELP["allowfullscreen"]       = "Consente di visualizzare il video a tutto schermo.|true,false";
$propertyHELP["showdigits"]            = "Visualizza i numeri.|true,false";
$propertyHELP["player"]                = "Path del player Flash.";
$propertyHELP["allowsciptaccess"]      = "Consente l'utilizzo degli script.|true,false";
$propertyHELP["quality"]               = "Consente di cambiare la qualità di riprouzione.|true,false";
