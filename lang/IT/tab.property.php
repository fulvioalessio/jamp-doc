...
$propertyHELP["display"]               = "Se \"display\"=\"tab1\" ogni volta che verrà visualizzato il tab verrà chiamata la funzione tab1Display();\nDi default viene impostato l'id dell'oggetto stesso. ";
$propertyHELP["tabs"]                  = "ID del TABS che contiene il tab. Proprietà impostata dal sistema.";
?>