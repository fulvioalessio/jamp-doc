...
$propertyHELP["cols"]                  = "Larghezza espressa il colonne.";
$propertyHELP["rows"]                  = "Altezza espressa in righe.";
...
$propertyHELP["editor-web"]            = "Attiva l'editor HTML.|true,false";
$propertyHELP["w3c"]                   = "Elimina i tag che non rispettano lo standard W3C";
$propertyHELP["editor-file"]           = "Percorso del file da caricare nell'editor highlight";
$propertyHELP["editor-lang"]           = "Sintassi riconosciuta dall'editor highlight.|csharp,css,generic,html,java,javascript,perl,ruby,php,text,sql,vbscript,jamp";
?>