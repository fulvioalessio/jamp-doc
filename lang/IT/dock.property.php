...
$propertyHELP["valign"]                = "Allineamento verticale del menu.|top,bottom";
...
$propertyHELP["dsrel"]                 = "Nome del campo dsrel associato.";
$propertyHELP["dsrev"]                 = "Nome del rev associato.";
?>