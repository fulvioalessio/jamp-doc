...
$propertyHELP["action"]                = "Destinazione del form.";
$propertyHELP["method"]                = "Metodo di invio dei dati.|get,post";
$propertyHELP["enctype"]               = "Codifica del form.|application/x-www-form-urlencoded,multipart/form-data";
